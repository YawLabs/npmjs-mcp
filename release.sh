...
PUBLISHED_VERSION=$(npm view @yawlabs/npmjs-mcp version 2>/dev/null || echo "")
...
if [ "$PUBLISHED_VERSION" = "$VERSION" ]; then
  ...
  info "Published @yawlabs/npmjs-mcp@${VERSION} to npm"
fi
...
NPM_VERSION=$(npm view @yawlabs/npmjs-mcp version 2>/dev/null || echo "")
